<%-- 
    ...
    Created on : 7 Mar, 2024, 10:25:28 PM
    Author     : devik
--%>
...
<html>
    <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Kalnia:wght@100;200;600&family=Lato:ital,wght@0,100;0,300;0,400;0,700;1,300;1,700&family=Playfair+Display:ital,wght@0,600;0,700;1,400&family=Roboto:wght@400;900&display=swap" rel="stylesheet">
        <link rel="stylesheet" href="home.css">
        <title>JSP_welcome</title>
    </head>
    <body>
        <body>
        <header>
        ...
        <div class=" container2">
            ...
            <div class="gallery1">
                ...
                <h1 class="galleryTitle">Self Defense<br>Resources</h1>
            </div>
        </div>
